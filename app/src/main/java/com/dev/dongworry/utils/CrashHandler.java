...
/**
 * Created by dengyaoning on 17/3/7.
 */
...
public void uncaughtException(Thread thread, Throwable ex) {
    ...
    String logMessage = String.format("CustomUncaughtExceptionHandler.uncaughtException: Thread %d Message %s", thread.getId(), ex.getMessage());
    PrintWriter printWriter = null;
    try {
        printWriter = new PrintWriter(new FileWriter(savePathFile, true));
        logMessage = String.format(Locale.getDefault(),"%s\r\n\r\n%s\r\n\r\nThread: %d\r\n\r\nMessage:\r\n\r\n%s\r\n\r\nStack Trace:\r\n\r\n%s",
