...
public class ListAppsAdapter extends SimpleAdapter  
{  
	private int[] appTo;  
     ...
     * @param to
     */
    public ListAppsAdapter(Context context, List<? extends Map<String, ?>> data,  
	...
	public List<? extends Map<String, ?>> getAppData() {
		return appData;
	}
