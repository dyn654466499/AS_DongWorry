...
public class GoodsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editText_goods_search.setOnClickListener(this);
		...
		// LayoutInflater.from(mContext).inflate(R.layout.activity_search,
		// null,false);
		// AutoLoadingUtils loadingUtils = new
		// AutoLoadingUtils(mContext,R.id.imageView_autoLoading);
...
//				getString(R.string.highestPrice), };
	...
	private void startSearchGoods(){
		 ...
		 */
		LinearLayout layout = (LinearLayout)findViewById(R.id.linearLayout_allCategories);
